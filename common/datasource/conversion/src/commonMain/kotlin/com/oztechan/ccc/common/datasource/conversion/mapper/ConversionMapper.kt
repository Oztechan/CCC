...
internal fun ConversionDBModel.toConversionModel() = Conversion(
    ...
    ILS, IMP, INR, IQD, IRR, ISK, JEP, JMD, JOD, JPY, KES, KGS, KHR, KMF, KRW, KWD,
    ...
    SLL, SOS, SRD, SSP, STN, SYP, SZL, THB, TJS, TMT, TND, TOP, TRY, TTD, TWD, TZS,
...
internal fun Conversion.toConversionDBModel() = ConversionDBModel(
    ...
    jpy, kes, kgs, khr, kmf, krw, kwd, kyd, kzt, lak, lbp, lkr, lrd, lsl, lyd, mad, mdl, mga,
    ...
    shp, sll, sos, srd, ssp, stn, syp, szl, thb, tjs, tmt, tnd, top, `try`, ttd, twd, tzs, uah,
