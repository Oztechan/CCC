...
internal fun ConversionDBModel.toConversionModel() = Conversion(
    ...
    SHP, SLL, SOS, SRD, SSP, STN, SYP, SZL, THB, TJS, TMT, TND, TOP, TRY, TTD, TWD,
    TZS, UAH, UGX, USD, UYU, UZS, VES, VND, VUV, WST, XAF, XCD, XDR, XOF, XPF, YER,
    ZAR, ZMW, ZWL
)
...
internal fun Conversion.toConversionDBModel() = ConversionDBModel(
    ...
    sgd, shp, sll, sos, srd, ssp, stn, syp, szl, thb, tjs, tmt, tnd, top, `try`, ttd, twd, tzs,
